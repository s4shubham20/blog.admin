            ...
            <form action="{{ route('post.update', $eid) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="name" class="form-control" id="category" placeholder="Category Name" value="{{ old('name' , $post->name) }}">
                        @error('name')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="alt" class="form-control" id="alt" placeholder="Alt" value="{{ old('alt', $post->alt) }}">
                        @error('alt')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="yt_iframe" class="form-control" id="yt_iframe" placeholder="Youtube iframe Link" value="{{ old('yt_iframe', $post->yt_iframe) }}">
                        @error('yt_iframe')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status"
                                        id="exampleRadios2" value="0" {{ $post->status == 0 ? 'checked':'' }}>
